<div class="container">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
        ...
        <p>&copy; 2022 Pemerintah Kota Lubuklinggau</p>
        <ul class="list-unstyled d-flex">
            <li class="ms-3"><a class="link-light fs-5" href="#"><i class="fab fa-twitter"></i></a></li>
            <li class="ms-3"><a class="link-light fs-5" href="#"><i class="fab fa-instagram"></i></a></li>
            <li class="ms-3"><a class="link-light fs-5" href="#"><i class="fab fa-facebook"></i></a></li>
        </ul>
    </div>
</div>
