...
@section('component')
    ...
    <div class="marketing">
        ...
        <div class="p-4 p-md-5 mb-4 rounded text-bg-dark shadow-sm">
            <div class="col-md-6 px-0">
                <h1 class="display-4 fst-italic">{{ $featured[0]->title }}</h1>
                <p class="lead my-3">{{ $featured[0]->excerpt }}</p>
                        ...
                        <div class="col-auto d-none d-lg-block">
                            @if (!$post->image)
                                <svg class="bd-placeholder-img" width="200" height="250"
                                    ...
                                    <rect width="100%" height="100%" fill="#55595c" /><text x="20%"
                                        y="50%" fill="#eceeef" dy=".3em">Tidak ada gambar</text>
                                </svg>
                            @else
