            ...
            <div class="col-md-4">
                <div class="position-sticky" style="top: 4rem;">
                    <div class="p-4 mb-3 bg-light rounded">
                        <img class="mb-2" src="/storage/{{ setting('admin.foto_lurah') }}" alt="Foto Lurah"
                            style="max-height: 10vmax; width: auto">
                        <p class="fw-bold mb-0">{{ setting('admin.nama_lurah') }}</p>
                        <p class="fst-italic"> Lurah {{ setting('site.title') }}</p>
